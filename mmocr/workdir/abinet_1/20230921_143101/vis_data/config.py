...
dictionary = dict(
    dict_file=
    '/mlcv/WorkingSpace/Personals/ngocnd/mmocr/configs/textrecog/abinet/../../../dicts/vietnam_digits_space.txt',
    same_start_end=True,
    type='Dictionary',
    with_end=True,
    with_padding=False,
...
naver_rec_test = dict(
    ann_file='random_forest_gt/abi_val_gt_1.json',
    data_prefix=dict(img_path='new_train/'),
    data_root='/mlcv/WorkingSpace/Personals/ngocnd/SoICT2023-OCR-Dataset/',
    pipeline=None,
    test_mode=True,
    type='OCRDataset')
naver_rec_train = dict(
    ann_file='random_forest_gt/abi_train_gt_1.json',
    data_prefix=dict(img_path='new_train/'),
    data_root='/mlcv/WorkingSpace/Personals/ngocnd/SoICT2023-OCR-Dataset/',
    pipeline=None,
    test_mode=False,
    ...
    dataset=dict(
        datasets=[
            dict(
                ...
                data_prefix=dict(img_path='new_train/'),
                data_root=
                '/mlcv/WorkingSpace/Personals/ngocnd/SoICT2023-OCR-Dataset/',
                pipeline=None,
                test_mode=True,
                type='OCRDataset'),
        ],
...
work_dir = '/mlcv/WorkingSpace/Personals/ngocnd/mmocr/workdir/abinet_1'
