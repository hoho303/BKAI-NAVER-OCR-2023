...
class ResNetABI(BaseModule):
    ...
    def forward(self, x):
        ...
        # VECTORS_PATH = "/workspace/Data/Backbone_vector/DataTrain"
        # file_name = str(global_file_count)
        # new_file_path = os.path.join(VECTORS_PATH, f"{file_name}.npy")
        # np.save(new_file_path, x.cpu().numpy())
        # global_file_count += 1
