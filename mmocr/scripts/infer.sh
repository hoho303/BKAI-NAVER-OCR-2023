...
python /workspace/mmocr/tools/infer.py \
        /data/SoICT2023-OCR-Dataset/new_public_test \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name abinet_v1 \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name abinet_v2 \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name abinet_v3 \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name abinet_final \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name satrn \
...
python /workspace/mmocr/tools/convert_pred.py \
        ...
        --img_path /data/SoICT2023-OCR-Dataset/new_public_test/\
        --output_dir /results/ --model_name master \