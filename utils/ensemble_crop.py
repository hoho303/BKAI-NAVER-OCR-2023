...
# Example usage:
PRED_FOLDER = '/workspace/preprocess_results/abinet'
OUTPUT_FILE = '/workspace/preprocess_results/abirest.txt'
DICT_FILE = '/workspace/data/dict.json'
ensemble_abinet(PRED_FOLDER, OUTPUT_FILE, DICT_FILE)

PRED_FOLDER = '/workspace/preprocess_results'
OUTPUT_FILE = '/workspace/preprocess_results/prediction.txt'
