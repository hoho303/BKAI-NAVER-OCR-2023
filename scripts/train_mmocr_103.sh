...
# =================================================================================================
#                               CORNER TRANSFORMER Model Training
cd /workspace/WordArt
python3 tools/train.py /workspace/WordArt/configs/textrecog/corner_transformer/corner_transformer_academic.py \
        --work-dir workdir/corner_transformer 
cd /workspace